...
product_spec=open("starter/phase_2/Product-Spec-Email-Router.txt").read()
...
# You will need to define a list of agent dictionaries (routes) for Product Manager, Program Manager, and Development Engineer. 
...
agents = [
    {
        ...
        "description":  """Defines user stories from a product spec by identifying personas,
            actions, and desired outcomes. Responsible for writing stories in the
            format 'As a [user], I want [action] so that [benefit]'. 
            Prioritizes features based on user value and business impact.""",
        "func": lambda x: product_manager_support_function(x) 
    },
    {
        "name": "Program Manager agent",
        "description": """Groups related user stories into cohesive product features.
            Responsible for prioritizing tasks based on dependencies,
            assigning tasks to team members, setting milestones and deadlines,
            monitoring progress, conducting status meetings, and coordinating
            across teams to ensure delivery.""",
        "func": lambda x: program_manager_support_function(x) 
    },
    {
        "name": "Development Engineer agent",
        "description": """Breaks down user stories into specific, actionable development tasks. 
            Responsible for estimating time and effort for each task, identifying 
            technical dependencies between tasks, defining acceptance criteria, 
            and specifying the engineering work required to implement each story.""",
